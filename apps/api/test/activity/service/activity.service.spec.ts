...
import {ActivityService} from '../../../../today-together/src/app/activity/service/activity.service';
...
describe('ActivityService', () => {
  ...
  beforeEach(async () => {
    ...
    sut = new ActivityService(instance(recommendActivityApi), instance(papagoApi));
  });
